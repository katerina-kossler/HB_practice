...
def is_mel(name, email):
    ...
    False
    >>> is_mel('Mel Melitpolski', 'string@gmail.com')
    True
    >>> is_mel('Yasmeen Atra', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type(goodie)
    ('dinner', 'dinner')
    ...
    >>> most_and_least_common_type(goodies)
    ('dinner', 'dinner')

    >>> no_goodies = []
    
    >>> most_and_least_common_type(no_goodies)
    (None, None)
